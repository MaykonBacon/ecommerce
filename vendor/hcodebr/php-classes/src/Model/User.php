...
class User extends Model{
	...
	public static function getForgot($email)
	{
		...
		else
		{
			...
			if (count($results2) === 0)
			{
				throw new \Exception("Não foi possível recuperar a senhayyy");
			}
			else
			{
				...
				$link = "http://www.mbecommerce.com.br/admin/forgot/reset?code=$code";

				$mailer = new Mailer($data["desemail"], $data["desperson"], "Redefinir senha da MB Store", "forgot", array(
					"name"=>$data["desperson"],
					"link"=>$link
					));
				$mailer->send();
